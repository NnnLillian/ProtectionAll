self.elementRepairDataInit = function (name) {
    var url, tableName;
    switch (name) {
        case 'elementRepairInfo':
            tableName = "element-repair-table";
            // local data
            // url = "js/tableData/json/elementRepairInfoList/elementRepair" + localStorage.getItem("element_category_id") + ".json";
            url = "/GetMaintainMsg?equipment_id=" + localStorage.getItem("element_category_id");
            break;
    ...
    $('#' + tableName).bootstrapTable('destroy').bootstrapTable({
        ...
        columns: [
            {
                field: 'element_maintain_id',
                title: '维修信息编号',
                align: 'center',
            }, {
                field: 'malfunction_description',
                title: '故障描述',
                align: 'center'
            }, {
