...
$(function () {
    var scripts = [
            '/Protection/js/bootstrap-table-locale-all.min.js',
            '/Protection/js/bootstrap-table-export.min.js',
            '/Protection/js/tableExport.min.js',
            '/Protection/js/bootstrap-table-editable.js',
        ],
